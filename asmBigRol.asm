...
AND RAX, R11;
; wyciagamy z RDX czesc pozostala 18158513697557839872 
;AND RDX, 18446744073709551552;
...
; teraz jadac od najm³odszego s³owa w wyniku do obecnej dlugosci wyniku robimy ROR
XOR R14,R14; na razie zeruje R14
XOR RDX,RDX; // zerujemy na pierwszy bajt wynikowego
loop2:
MOV RAX,[R9+RDX*8];
ROL RAX, cl;
MOV R13,RAX;
